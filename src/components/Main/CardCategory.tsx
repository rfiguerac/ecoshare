...
export const CardCategory = (props: CardCategoryProps) => {
  ...
  return (
    <div className="card border border-gray-200 rounded-lg flex flex-col w-96 p-6 shadow-lg transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl hover:cursor-pointer">
