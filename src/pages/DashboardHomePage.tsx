...
export const DashboardHome = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const totalActiveDonations = (donationPagination.data ?? []).filter((donation: Donation) => donation.status === "Available").length;
      // Total closed donations
      const totalClosedDonations = (donationPagination.data ?? []).filter((donation: Donation) => donation.status === "Donated").length;
