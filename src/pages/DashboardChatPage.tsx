                        ...
                        {chats.map((chat) => (
                            <div
                                ...
                                className={`
                                    ...
                                    ${chat.isRead ? "bg-white hover:bg-gray-100" : "bg-blue-50 hover:bg-blue-100"}
                                `}
                            >
                                <div className="flex justify-between items-center mb-1">
                                    <span className={`font-semibold ${chat.isRead ? "text-gray-800" : "text-gray-900"}`}>
                                        {chat.sender}
                                    </span>
                                    <span className="text-sm text-gray-500">{chat.timestamp}</span>
                                </div>
                                <p className={`text-sm ${chat.isRead ? "text-gray-600" : "text-gray-800 font-medium"}`}>
                                    {chat.lastMessage}
                                </p>
                            </div>
                        ))}
        ...
        <div className="flex w-full max-w-7xl mx-auto mt-10 p-4 bg-gray-50 rounded-lg shadow-lg">
            <div className="flex-1">
                <div className="flex items-center mb-6">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800">{selectedChat ? selectedChat.sender : ""}</h1>
                </div>
