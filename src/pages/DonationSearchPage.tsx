...
import { CardDonation } from '../components/donation/donation/CardDonation';
...
export const DonationSearchPage = () => {
    ...
    useEffect(() => {
        ...
        if (!query) {
            ...
            const filtered : Donation[] = donations.filter(donation =>
                ...
                (matchedCategory.length > 0 && matchedCategory.some(category => donation.idCategory === category.idCategory))
            );
